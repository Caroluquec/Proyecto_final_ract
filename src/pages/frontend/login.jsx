...
import Logindata from '../../componentes/frontend/logindata';
                                          ...
                                          <div className="form-group">
                                              <input type="text"{...register("username",
                                                {required: true}
                                                  ...
                                                  <span className='text-danger'>{errors.username && "El usuario es obligatorio"}</span>
                                          </div>
                                          <div className="form-group">
                                              <input type="password" {...register("password",
                                               {required: true})} className="form-control form-control-user"
